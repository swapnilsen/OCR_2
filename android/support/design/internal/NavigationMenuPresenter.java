...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private class NavigationMenuAdapter extends Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            switch (getItemViewType(i)) {
                case VIEW_TYPE_NORMAL /*0*/:
                    ...
                    navigationMenuItemView.initialize(navigationMenuTextItem.getMenuItem(), VIEW_TYPE_NORMAL);
                case VIEW_TYPE_SUBHEADER /*1*/:
                ...
                while (i3 < size) {
                    ...
                    if (menuItemImpl.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            for (i5 = VIEW_TYPE_NORMAL; i5 < size3; i5 += VIEW_TYPE_SUBHEADER) {
        ...
        public Bundle createInstanceState() {
            ...
            for (int i = VIEW_TYPE_NORMAL; i < size; i += VIEW_TYPE_SUBHEADER) {
                NavigationMenuItem navigationMenuItem = (NavigationMenuItem) this.mItems.get(i);
                if (navigationMenuItem instanceof NavigationMenuTextItem) {
        ...
        public void restoreInstanceState(Bundle bundle) {
            ...
            int i2 = bundle.getInt(STATE_CHECKED_ITEM, VIEW_TYPE_NORMAL);
            if (i2 != 0) {
                this.mUpdateSuspended = true;
                int size = this.mItems.size();
                for (int i3 = VIEW_TYPE_NORMAL; i3 < size; i3 += VIEW_TYPE_SUBHEADER) {
