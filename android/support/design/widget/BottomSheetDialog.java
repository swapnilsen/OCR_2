    ...
    class C00302 extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (BottomSheetDialog.this.mCancelable) {
                accessibilityNodeInfoCompat.addAction((int) AccessibilityNodeInfoCompat.ACTION_DISMISS);
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            if (i != AccessibilityNodeInfoCompat.ACTION_DISMISS || !BottomSheetDialog.this.mCancelable) {
