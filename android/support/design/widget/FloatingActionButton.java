...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class C00371 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C00371(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            this.mAutoHideEnabled = obtainStyledAttributes.getBoolean(C0003R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0003R.styleable.FloatingActionButton_backgroundTintMode, SIZE_AUTO), null);
        this.mRippleColor = obtainStyledAttributes.getColor(C0003R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = obtainStyledAttributes.getInt(C0003R.styleable.FloatingActionButton_fabSize, SIZE_AUTO);
    ...
    private InternalVisibilityChangedListener wrapOnVisibilityChangedListener(@Nullable OnVisibilityChangedListener onVisibilityChangedListener) {
        ...
        return new C00371(onVisibilityChangedListener);
    }
