...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(C0003R.styleable.NavigationView_itemIconTint)) {
            colorStateList = obtainStyledAttributes.getColorStateList(C0003R.styleable.NavigationView_itemIconTint);
        } else {
    ...
    private ColorStateList createDefaultColorStateList(int i) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0268R.attr.colorPrimary, typedValue, true)) {
            return null;
        }
