...
public class TextInputLayout extends LinearLayout {
    ...
    class C00543 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ CharSequence val$error;

        C00543(CharSequence charSequence) {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.getResourceId(C0003R.styleable.TextInputLayout_hintTextAppearance, INVALID_MAX_LENGTH) != INVALID_MAX_LENGTH) {
        ...
        setCounterMaxLength(obtainStyledAttributes.getInt(C0003R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
        ...
        if (obtainStyledAttributes.hasValue(C0003R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0003R.styleable.TextInputLayout_passwordToggleTintMode, INVALID_MAX_LENGTH), null);
        }
    ...
    private void setError(@Nullable CharSequence charSequence, boolean z) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C00543(charSequence)).start();
            } else {
                this.mErrorView.setText(charSequence);
                this.mErrorView.setVisibility(4);
            }
