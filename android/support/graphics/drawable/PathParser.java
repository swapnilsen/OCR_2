...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            float f6 = fArr[5];
            switch (c2) {
                case C0268R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C0268R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    i = 7;
                    break;
                case C0268R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                ...
                case 'v':
                    i = 1;
                    break;
                case C0268R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C0268R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
                case C0268R.styleable.AppCompatTheme_colorPrimaryDark /*84*/:
                case C0268R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                case C0268R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                case 't':
                    i = 2;
                    break;
                case C0268R.styleable.AppCompatTheme_panelMenuListTheme /*81*/:
                case C0268R.styleable.AppCompatTheme_colorPrimary /*83*/:
                case C0268R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    i = 4;
                    break;
