...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        private android.app.Notification.Builder f345b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f345b, action));
        }
        ...
        public Notification build() {
            ...
            this.f345b.setExtras(this.mExtras);
            Notification build = this.f345b.build();
