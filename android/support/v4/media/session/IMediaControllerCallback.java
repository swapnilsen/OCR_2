        ...
        private static class Proxy implements IMediaControllerCallback {
            ...
            public void onRepeatModeChanged(int i) {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onRepeatModeChanged, obtain, null, Stub.TRANSACTION_onEvent);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onShuffleModeChanged(boolean z) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onShuffleModeChanged, obtain, null, Stub.TRANSACTION_onEvent);
                } finally {
                    obtain.recycle();
                }
            }
