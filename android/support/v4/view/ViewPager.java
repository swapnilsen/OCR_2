...
public class ViewPager extends ViewGroup {
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() == CodedOutputStream.DEFAULT_BUFFER_SIZE && ViewPager.this.mAdapter != null) {
    ...
    public void setPageTransformer(boolean z, PageTransformer pageTransformer) {
        setPageTransformer(z, pageTransformer, SCROLL_STATE_SETTLING);
    }

    public void setPageTransformer(boolean z, PageTransformer pageTransformer, int i) {
        int i2 = SCROLL_STATE_DRAGGING;
        if (VERSION.SDK_INT >= 11) {
            ...
            int i3 = z3 != z2 ? SCROLL_STATE_DRAGGING : SCROLL_STATE_IDLE;
    ...
    void dataSetChanged() {
        ...
        if (this.mItems.size() >= (this.mOffscreenPageLimit * SCROLL_STATE_SETTLING) + SCROLL_STATE_DRAGGING || this.mItems.size() >= count) {
            z = DEBUG;
        } else {
            z = true;
        }
        ...
        for (int i4 = SCROLL_STATE_IDLE; i4 < childCount; i4 += SCROLL_STATE_DRAGGING) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    int i7 = layoutParams.gravity & C0268R.styleable.AppCompatTheme_spinnerStyle;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.isDecor) {
                    int i9 = layoutParams.gravity & C0268R.styleable.AppCompatTheme_spinnerStyle;
