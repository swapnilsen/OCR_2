...
class ViewPropertyAnimatorCompatICS {
    ...
    public static void m446x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m447y(View view, float f) {
        view.animate().y(f);
    }
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C02061(viewPropertyAnimatorListener, view));
        } else {
