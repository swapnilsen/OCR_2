...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c02221 = new C02221(ring);
        c02221.setRepeatCount(-1);
        c02221.setRepeatMode(DEFAULT);
        c02221.setInterpolator(LINEAR_INTERPOLATOR);
        c02221.setAnimationListener(new C02232(ring));
        this.mAnimation = c02221;
    }
}
