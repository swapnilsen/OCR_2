...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    class C02531 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & CodedOutputStream.DEFAULT_BUFFER_SIZE) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(C0268R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            if (windowCallback != null) {
                windowCallback.onMenuOpened(C0268R.styleable.AppCompatTheme_ratingBarStyle, menuBuilder);
            }
            return true;
        }
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0268R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0268R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0268R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0268R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0268R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0268R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (panelState == null || panelState.menu == null) {
                    invalidatePanelMenu(C0268R.styleable.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0268R.styleable.AppCompatTheme_windowActionBar)) {
            View view;
            if (obtainStyledAttributes.getBoolean(C0268R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0268R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(C0268R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (obtainStyledAttributes.getBoolean(C0268R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0268R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (obtainStyledAttributes.getBoolean(C0268R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0268R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionMode) {
                    view2 = (ViewGroup) from.inflate(C0268R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    view2 = (ViewGroup) from.inflate(C0268R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new C02542());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new C02553());
                    view = view2;
                }
            } else if (this.mIsFloating) {
                r0 = (ViewGroup) from.inflate(C0268R.layout.abc_dialog_title_material, null);
                ...
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0268R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                r0 = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0268R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) r0.findViewById(C0268R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0268R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) view.findViewById(C0268R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(view);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0268R.id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C02564());
            return view;
        }
        obtainStyledAttributes.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0268R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0268R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0268R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0268R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0268R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0268R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    public boolean requestWindowFeature(int i) {
        ...
        if (this.mWindowNoTitle && sanitizeWindowFeatureId == C0268R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
        ...
        switch (sanitizeWindowFeatureId) {
            ...
            case HttpRequest.DEFAULT_NUMBER_OF_RETRIES /*10*/:
                ...
                return true;
            case C0268R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int i, Menu menu) {
        if (i == C0268R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    theme.resolveAttribute(C0268R.attr.actionBarTheme, typedValue, true);
                    if (typedValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(contextThemeWrapper, null, C0268R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    contextThemeWrapper.getTheme().resolveAttribute(C0268R.attr.actionBarSize, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0268R.id.action_mode_bar_stub);
    ...
    private void reopenMenu(MenuBuilder menuBuilder, boolean z) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && z) {
            ...
            if (!isDestroyed()) {
                windowCallback.onPanelClosed(C0268R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (panelState2.menu != null && !panelState2.refreshMenuContent && windowCallback.onPreparePanel(0, panelState2.createdPanelView, panelState2.menu)) {
                windowCallback.onMenuOpened(C0268R.styleable.AppCompatTheme_ratingBarStyle, panelState2.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == C0268R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue typedValue = new TypedValue();
            ...
            if (typedValue.resourceId != 0) {
                ...
                theme2.resolveAttribute(C0268R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0268R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        boolean z = panelFeatureState.featureId == 0 || panelFeatureState.featureId == C0268R.styleable.AppCompatTheme_ratingBarStyle;
    ...
    void checkCloseActionMenu(MenuBuilder menuBuilder) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback windowCallback = getWindowCallback();
            if (!(windowCallback == null || isDestroyed())) {
                windowCallback.onPanelClosed(C0268R.styleable.AppCompatTheme_ratingBarStyle, menuBuilder);
            }
    ...
    void doInvalidatePanelMenu(int i) {
        ...
        panelState.refreshDecorView = true;
        if ((i == C0268R.styleable.AppCompatTheme_ratingBarStyle || i == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int i) {
        if (i == 8) {
            ...
            return C0268R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (i != 9) {
            return i;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0268R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
