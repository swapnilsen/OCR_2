...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, C0268R.styleable.DrawerArrowToggle, C0268R.attr.drawerArrowStyle, C0268R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(obtainStyledAttributes.getColor(C0268R.styleable.DrawerArrowToggle_color, ARROW_DIRECTION_LEFT));
        setBarThickness(obtainStyledAttributes.getDimension(C0268R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(obtainStyledAttributes.getBoolean(C0268R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(obtainStyledAttributes.getDimension(C0268R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(C0268R.styleable.DrawerArrowToggle_drawableSize, ARROW_DIRECTION_LEFT);
        this.mBarLength = (float) Math.round(obtainStyledAttributes.getDimension(C0268R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(obtainStyledAttributes.getDimension(C0268R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = obtainStyledAttributes.getDimension(C0268R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * f)) - (this.mBarGap * 2.0f))) / 4) * ARROW_DIRECTION_START))) + ((((double) f) * ExponentialBackOffPolicy.DEFAULT_MULTIPLIER) + ((double) this.mBarGap))));
        if (this.mSpin) {
