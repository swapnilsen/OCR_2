...
public class AsyncListUtil<T> {
    ...
    class C02711 implements MainThreadCallback<T> {
        C02711() {
        }
    ...
    class C02722 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> cls, int i, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02711();
        this.mBackgroundCallback = new C02722();
        this.mTClass = cls;
        this.mTileSize = i;
