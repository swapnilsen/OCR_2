...
public class ActionBarPolicy {
    ...
    public int getMaxActionButtons() {
        ...
        if (screenWidthDp >= HttpStatusCodes.STATUS_CODE_SERVER_ERROR || ((screenWidthDp > 640 && screenHeightDp > 480) || (screenWidthDp > 480 && screenHeightDp > 640))) {
            return 4;
        }
    ...
    public int getTabContainerHeight() {
        ...
        int layoutDimension = obtainStyledAttributes.getLayoutDimension(C0268R.styleable.ActionBar_height, 0);
        Resources resources = this.mContext.getResources();
        if (!hasEmbeddedTabs()) {
            layoutDimension = Math.min(layoutDimension, resources.getDimensionPixelSize(C0268R.dimen.abc_action_bar_stacked_max_height));
        }
