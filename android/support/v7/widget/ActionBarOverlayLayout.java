...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    static {
        ATTRS = new int[]{C0268R.attr.actionBarSize, 16842841};
    }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0268R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0268R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0268R.id.action_bar));
        }
    }
