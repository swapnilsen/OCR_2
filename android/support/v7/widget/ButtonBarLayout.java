...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0268R.styleable.ButtonBarLayout);
        this.mAllowStacking = obtainStyledAttributes.getBoolean(C0268R.styleable.ButtonBarLayout_allowStacking, z);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mAllowStacking && !isStacked()) {
            ...
            if (VERSION.SDK_INT >= 11) {
                z2 = (ViewCompat.getMeasuredWidthAndState(this) & ViewCompat.MEASURED_STATE_MASK) == AccessibilityEventCompat.TYPE_ASSIST_READING_CONTEXT;
            } else {
                int i4 = 0;
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0268R.id.spacer);
