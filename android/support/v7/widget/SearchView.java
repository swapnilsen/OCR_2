...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0268R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0268R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0268R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0268R.styleable.SearchView_layout, C0268R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0268R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0268R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0268R.id.search_plate);
        this.mSubmitArea = findViewById(C0268R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0268R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0268R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0268R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0268R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0268R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0268R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0268R.styleable.SearchView_suggestionRowLayout, C0268R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0268R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0268R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0268R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0268R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0268R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0268R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0268R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0268R.styleable.SearchView_android_focusable, true));
    ...
    private void updateQueryHint() {
        ...
        if (queryHint == null) {
            queryHint = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
        }
    ...
    void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mSearchSrcTextView.getText())) {
            this.mSearchSrcTextView.setText(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING);
    ...
    public void onActionViewCollapsed() {
        setQuery(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, DBG);
        clearFocus();
        updateViewsVisibility(true);
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0268R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0268R.dimen.abc_dropdownitem_icon_width);
            } else {
