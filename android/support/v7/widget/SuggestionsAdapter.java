...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0268R.id.edit_query);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        String charSequence2 = charSequence == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : charSequence.toString();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0268R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0268R.attr.textColorSearchUrl, typedValue, true);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        String[] strArr;
        Builder fragment = new Builder().scheme(Param.CONTENT).authority(suggestAuthority).query(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING).fragment(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING);
