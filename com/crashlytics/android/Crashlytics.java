...
import p000a.p001a.p002a.p003a.KitGroup;
...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    public static Crashlytics getInstance() {
        return (Crashlytics) Fabric.m389a(Crashlytics.class);
    }
    ...
    public void setDebugMode(boolean z) {
        Fabric.m397h().m364d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        Fabric.m397h().m364d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return Fabric.m398i();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        Fabric.m397h().m364d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
