...
class NativeCrashWriter {
    ...
    private static final class CustomAttributeMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            return CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : this.value)) + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8(this.key));
        }

        public void writeProperties(CodedOutputStream codedOutputStream) {
            codedOutputStream.writeBytes(1, ByteString.copyFromUtf8(this.key));
            codedOutputStream.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : this.value));
        }
    }
    ...
    static {
        DEFAULT_SIGNAL = new SignalData(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, 0);
