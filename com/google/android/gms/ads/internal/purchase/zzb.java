...
public class zzb {
    ...
    public void zzV(IBinder iBinder) {
        try {
            ...
            if (this.zzPr) {
                zzqf.zzbh("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.");
            }
        }
    }
    ...
    public Bundle zza(String str, String str2, String str3) {
        try {
            ...
            if (this.zzPr) {
                zzqf.zzc("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", e);
            }
            return null;
        }
    }
