...
public abstract class zzi implements OnClickListener {
    ...
    class C09871 extends zzi {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;

        C09871(Intent intent, Activity activity, int i) {
    ...
    class C09882 extends zzi {
        final /* synthetic */ Fragment val$fragment;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;

        C09882(Intent intent, Fragment fragment, int i) {
            this.val$intent = intent;
    ...
    class C09893 extends zzi {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;
        final /* synthetic */ zzabf zzaFF;

        C09893(Intent intent, zzabf com_google_android_gms_internal_zzabf, int i) {
            this.val$intent = intent;
