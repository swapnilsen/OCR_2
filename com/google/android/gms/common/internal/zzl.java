...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C09901 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaFS;

        C09901(ConnectionCallbacks connectionCallbacks) {
    ...
    class C09912 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaFT;

        C09912(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C09901(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C09912(onConnectionFailedListener);
    }
