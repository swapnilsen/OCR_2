...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class zza implements zzy {
            ...
            public IObjectWrapper zza(IObjectWrapper iObjectWrapper, int i, int i2) {
            ...
            public IObjectWrapper zza(IObjectWrapper iObjectWrapper, zzah com_google_android_gms_common_internal_zzah) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.common.internal.ISignInButtonCreator");
    ...
    IObjectWrapper zza(IObjectWrapper iObjectWrapper, int i, int i2);

    IObjectWrapper zza(IObjectWrapper iObjectWrapper, zzah com_google_android_gms_common_internal_zzah);
}
