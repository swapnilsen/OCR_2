...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzyL() {
        ...
        String join = zzyQ() == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : TextUtils.join(",", zzyQ());
        String valueOf5 = String.valueOf("\t");
        int zzyT = zzyT();
        String valueOf6 = String.valueOf("\t");
        String zzyN = zzyN() == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : zzyN();
        String valueOf7 = String.valueOf("\t");
        String zzyU = zzyU() == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : zzyU();
        String valueOf8 = String.valueOf("\t");
        float zzyV = zzyV();
        String valueOf9 = String.valueOf("\t");
        String zzyO = zzyO() == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : zzyO();
