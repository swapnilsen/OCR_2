...
public class zza {
    private static final Object zzaGb;
    private static zza zzaHq;
    private final List<String> zzaHr;
    private final List<String> zzaHs;
    ...
    private zza() {
        this.zzaHr = Collections.EMPTY_LIST;
        this.zzaHs = Collections.EMPTY_LIST;
        this.zzaHt = Collections.EMPTY_LIST;
        this.zzaHu = Collections.EMPTY_LIST;
    }
