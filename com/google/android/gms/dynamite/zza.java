...
public interface zza extends IInterface {
    ...
    public static abstract class zza extends Binder implements zza {
        ...
        private static class zza implements zza {
            ...
            public int zza(IObjectWrapper iObjectWrapper, String str, boolean z) {
                int i = 0;
            ...
            public IObjectWrapper zza(IObjectWrapper iObjectWrapper, String str, int i) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamite.IDynamiteLoader");
            ...
            public int zze(IObjectWrapper iObjectWrapper, String str) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamite.IDynamiteLoader");
    ...
    int zze(IObjectWrapper iObjectWrapper, String str);
}
