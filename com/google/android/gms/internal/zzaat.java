...
public final class zzaat extends GoogleApiClient implements com.google.android.gms.internal.zzabc.zza {
    ...
    class C10291 implements com.google.android.gms.common.internal.zzm.zza {
        final /* synthetic */ zzaat zzaBY;

        C10291(zzaat com_google_android_gms_internal_zzaat) {
    ...
    class C10302 implements ConnectionCallbacks {
        final /* synthetic */ zzaat zzaBY;
        final /* synthetic */ AtomicReference zzaBZ;
        final /* synthetic */ zzabt zzaCa;

        C10302(zzaat com_google_android_gms_internal_zzaat, AtomicReference atomicReference, zzabt com_google_android_gms_internal_zzabt) {
            this.zzaBY = com_google_android_gms_internal_zzaat;
    ...
    class C10313 implements OnConnectionFailedListener {
        final /* synthetic */ zzabt zzaCa;

        C10313(zzaat com_google_android_gms_internal_zzaat, zzabt com_google_android_gms_internal_zzabt) {
            this.zzaCa = com_google_android_gms_internal_zzabt;
        }
    ...
    class C10324 implements ResultCallback<Status> {
        final /* synthetic */ zzaat zzaBY;
        final /* synthetic */ zzabt zzaCa;
        final /* synthetic */ boolean zzaCb;
        final /* synthetic */ GoogleApiClient zzapg;

        C10324(zzaat com_google_android_gms_internal_zzaat, zzabt com_google_android_gms_internal_zzabt, boolean z, GoogleApiClient googleApiClient) {
            this.zzaBY = com_google_android_gms_internal_zzaat;
            this.zzaCa = com_google_android_gms_internal_zzabt;
            this.zzaCb = z;
    ...
    private void zza(GoogleApiClient googleApiClient, zzabt com_google_android_gms_internal_zzabt, boolean z) {
        zzacf.zzaGM.zzg(googleApiClient).setResultCallback(new C10324(this, com_google_android_gms_internal_zzabt, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzaBQ.containsKey(zzacf.zzaid)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzacf.API).addConnectionCallbacks(new C10302(this, atomicReference, com_google_android_gms_internal_zzabt)).addOnConnectionFailedListener(new C10313(this, com_google_android_gms_internal_zzabt)).setHandler(this.zzaBO).build();
