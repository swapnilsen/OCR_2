...
public class zzabr extends zzbam implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    class C10391 implements Runnable {
        ...
        C10391(zzabr com_google_android_gms_internal_zzabr, zzbaw com_google_android_gms_internal_zzbaw) {
    ...
    public void zzb(zzbaw com_google_android_gms_internal_zzbaw) {
        this.mHandler.post(new C10391(this, com_google_android_gms_internal_zzbaw));
    }
