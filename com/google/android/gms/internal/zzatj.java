...
class zzatj extends zzauh {
    private static final Map<String, String> zzbrg;
    ...
    zzatj(zzaue com_google_android_gms_internal_zzaue) {
        ...
        this.zzbrl = new zzc(this, getContext(), zzow());
    }
    ...
    @WorkerThread
    static void zza(zzatx com_google_android_gms_internal_zzatx, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, Map<String, String> map) {
        if (com_google_android_gms_internal_zzatx == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
    ...
    @WorkerThread
    static void zza(zzatx com_google_android_gms_internal_zzatx, SQLiteDatabase sQLiteDatabase, String str, String str2, Map<String, String> map) {
        if (com_google_android_gms_internal_zzatx == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
    ...
    public long zza(zze com_google_android_gms_internal_zzauw_zze) {
        zzmR();
        zzob();
    ...
    public void zza(String str, long j, long j2, zzb com_google_android_gms_internal_zzatj_zzb) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            str2 = j2 != -1 ? "rowid <= ? and " : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
        ...
        str2 = j2 != -1 ? " and rowid <= ?" : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
    ...
    public List<zzaus> zzft(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", Param.ORIGIN, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzKn().zzKX()));
            try {
                if (query.moveToFirst()) {
                    do {
                        String string = query.getString(0);
    ...
    L_0x0058:
        ...
        r6 = r11.zzKh();	 Catch:{ IOException -> 0x007a }
    ...
    L_0x007a:
        r1 = move-exception;
        r4 = r11.zzKl();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r4 = r4.zzLY();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
    ...
    L_0x00b1:
        ...
        r1 = r2;
    L_0x00b3:
        r2 = r11.zzKl();	 Catch:{ all -> 0x00ec }
        r2 = r2.zzLY();	 Catch:{ all -> 0x00ec }
