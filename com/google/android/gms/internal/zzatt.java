...
public interface zzatt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzatt {
        ...
        private static class zza implements zzatt {
            ...
            public List<zzatg> zza(String str, String str2, zzatd com_google_android_gms_internal_zzatd) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.measurement.internal.IMeasurementService");
            ...
            public List<zzatg> zzn(String str, String str2, String str3) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.measurement.internal.IMeasurementService");
    ...
    List<zzauq> zza(zzatd com_google_android_gms_internal_zzatd, boolean z);

    List<zzatg> zza(String str, String str2, zzatd com_google_android_gms_internal_zzatd);

    List<zzauq> zza(String str, String str2, String str3, boolean z);

    List<zzauq> zza(String str, String str2, boolean z, zzatd com_google_android_gms_internal_zzatd);

    void zza(long j, String str, String str2, String str3);

    void zza(zzatd com_google_android_gms_internal_zzatd);

    void zza(zzatg com_google_android_gms_internal_zzatg, zzatd com_google_android_gms_internal_zzatd);

    void zza(zzatq com_google_android_gms_internal_zzatq, zzatd com_google_android_gms_internal_zzatd);

    void zza(zzatq com_google_android_gms_internal_zzatq, String str, String str2);

    void zza(zzauq com_google_android_gms_internal_zzauq, zzatd com_google_android_gms_internal_zzatd);

    byte[] zza(zzatq com_google_android_gms_internal_zzatq, String str);

    void zzb(zzatd com_google_android_gms_internal_zzatd);

    void zzb(zzatg com_google_android_gms_internal_zzatg);

    String zzc(zzatd com_google_android_gms_internal_zzatd);

    List<zzatg> zzn(String str, String str2, String str3);
}
