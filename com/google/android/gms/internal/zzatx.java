...
public class zzatx extends zzauh {
    ...
    class C10641 implements Runnable {
        final /* synthetic */ String zzbsK;
        final /* synthetic */ zzatx zzbsL;

        C10641(zzatx com_google_android_gms_internal_zzatx, String str) {
    ...
    static String zzc(boolean z, Object obj) {
        ...
        if (valueOf instanceof Long) {
            ...
            String str = String.valueOf(valueOf).charAt(0) == '-' ? "-" : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
    ...
    public void zzb(int i, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzMv == null) {
            ...
            zzMv.zzm(new C10641(this, valueOf));
        } else {
