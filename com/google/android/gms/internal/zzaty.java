        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    if (this.zzaIQ != null) {
                        ...
                        try {
                            ...
                            this.zzbsU.zzKk().zzm(new zzb(this.zzbsS, i, e, null, map, null));
                        } catch (Throwable th2) {
                            th = th2;
                            map2 = null;
                            if (outputStream != null) {
                            ...
                            this.zzbsU.zzKk().zzm(new zzb(this.zzbsS, i2, null, null, map2, null));
                            throw th;
                        }
                    }
                ...
                try {
                    ...
                    this.zzbsU.zzKk().zzm(new zzb(this.zzbsS, i2, null, zza, map2, null));
