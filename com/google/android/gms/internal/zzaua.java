...
class zzaua extends zzauh {
    static final Pair<String, Long> zzbsX;
    ...
    static {
        zzbsX = new Pair(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, Long.valueOf(0));
    }

    zzaua(zzaue com_google_android_gms_internal_zzaue) {
        super(com_google_android_gms_internal_zzaue);
        this.zzbsY = new zzc("health_monitor", zzKn().zzpz(), null);
        this.zzbsZ = new zzb(this, "last_upload", 0);
        this.zzbta = new zzb(this, "last_upload_attempt", 0);
        this.zzbtb = new zzb(this, "backoff", 0);
        this.zzbtc = new zzb(this, "last_delete_stale", 0);
        this.zzbtl = new zzb(this, "time_before_start", 10000);
        this.zzbtm = new zzb(this, "session_timeout", 1800000);
        this.zzbtn = new zza(this, "start_new_session", true);
        this.zzbto = new zzb(this, "last_pause_time", 0);
        this.zzbtp = new zzb(this, "time_active", 0);
        this.zzbtd = new zzb(this, "midnight_offset", 0);
    ...
    Pair<String, Boolean> zzfG(String str) {
        ...
        try {
            ...
            if (this.zzbte == null) {
                this.zzbte = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
            }
