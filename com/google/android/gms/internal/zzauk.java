...
public class zzauk extends zzauh {
    ...
    private final CopyOnWriteArrayList<zzd> zzbvr;
    ...
    class C10911 implements Runnable {
        final /* synthetic */ boolean zzbvv;
        final /* synthetic */ zza zzbvw;
        final /* synthetic */ zzauk zzbvx;

        C10911(zzauk com_google_android_gms_internal_zzauk, boolean z, zza com_google_android_gms_internal_zzauk_zza) {
            this.zzbvx = com_google_android_gms_internal_zzauk;
            this.zzbvv = z;
            this.zzbvw = com_google_android_gms_internal_zzauk_zza;
        }

        public void run() {
            if (this.zzbvv && this.zzbvx.zzbvm != null) {
                this.zzbvx.zza(this.zzbvx.zzbvm);
            }
            this.zzbvx.zzbvm = this.zzbvw;
            this.zzbvx.zzKd().zza(this.zzbvw);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzauk.2 */
    class C10922 implements Runnable {
        final /* synthetic */ zzauk zzbvx;
        final /* synthetic */ zza zzbvy;

        C10922(zzauk com_google_android_gms_internal_zzauk, zza com_google_android_gms_internal_zzauk_zza) {
            this.zzbvx = com_google_android_gms_internal_zzauk;
            this.zzbvy = com_google_android_gms_internal_zzauk_zza;
        }

        public void run() {
            this.zzbvx.zza(this.zzbvy);
    ...
    private void zza(Activity activity, zza com_google_android_gms_internal_zzauk_zza, boolean z) {
        ...
        if (i != 0) {
            ...
            zzKk().zzm(new C10911(this, z, com_google_android_gms_internal_zzauk_zza2));
        }
    }
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                ...
                zzv.zzbqh = bundle2.getLong(FacebookAdapter.KEY_ID);
    ...
    public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (com_google_android_gms_internal_zzauk_zza != null) {
                ...
                bundle2.putLong(FacebookAdapter.KEY_ID, com_google_android_gms_internal_zzauk_zza.zzbqh);
