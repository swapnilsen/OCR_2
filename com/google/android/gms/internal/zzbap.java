...
public interface zzbap extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbap {
        ...
        private static class zza implements zzbap {
            ...
            public void zza(ConnectionResult connectionResult, zzbak com_google_android_gms_internal_zzbak) {
    ...
    void zza(ConnectionResult connectionResult, zzbak com_google_android_gms_internal_zzbak);

    void zza(Status status, GoogleSignInAccount googleSignInAccount);

    void zzb(zzbaw com_google_android_gms_internal_zzbaw);
