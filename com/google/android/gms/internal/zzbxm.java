...
public final class zzbxm {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(C0268R.styleable.AppCompatTheme_ratingBarStyle).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    public void zza(int i, zzbxt com_google_android_gms_internal_zzbxt) {
        zzN(i, 2);
    ...
    public void zzb(zzbxt com_google_android_gms_internal_zzbxt) {
    ...
    public void zzbh(long j) {
        while ((-128 & j) != 0) {
            zzri((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            j >>>= 7;
        }
        zzri((int) j);
    }
    ...
    public void zzc(zzbxt com_google_android_gms_internal_zzbxt) {
    ...
    public void zzrk(int i) {
        while ((i & -128) != 0) {
            zzri((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            i >>>= 7;
        }
        zzri(i);
    }
