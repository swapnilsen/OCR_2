...
public class zzdb {
    ...
    public zzdb(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        this.zzxy = 0;
        this.zzxz = 0;
        this.zzxB = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
        this.zzxC = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
        this.zzxD = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
        this.zzxp = i;
        this.zzxq = i2;
        this.zzxr = i3;
