...
public final class zzkl implements NativeMediationAdRequest {
    ...
    public zzkl(@Nullable Date date, int i, @Nullable Set<String> set, @Nullable Location location, boolean z, int i2, zzhc com_google_android_gms_internal_zzhc, List<String> list, boolean z2) {
        this.zzcR = date;
        this.zzzk = i;
        this.zzcT = set;
        this.zzcV = location;
