...
public final class zzqd {
    ...
    private OnGlobalLayoutListener zzYN;
    private OnScrollChangedListener zzYO;

    public zzqd(Activity activity, View view, OnGlobalLayoutListener onGlobalLayoutListener, OnScrollChangedListener onScrollChangedListener) {
        this.zzYJ = activity;
        this.mView = view;
