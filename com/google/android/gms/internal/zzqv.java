...
public class zzqv {
    ...
    public zzqv(Context context, ViewGroup viewGroup, zzqw com_google_android_gms_internal_zzqw) {
        this(context, viewGroup, com_google_android_gms_internal_zzqw, null);
    }

    zzqv(Context context, ViewGroup viewGroup, zzqw com_google_android_gms_internal_zzqw, zzl com_google_android_gms_ads_internal_overlay_zzl) {
