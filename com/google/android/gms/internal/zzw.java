...
public class zzw implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) {
            ...
            if (com_google_android_gms_internal_zzw_zza.zza.equals(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzw.zza(outputStream, this.zza == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : this.zza);
