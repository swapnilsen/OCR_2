...
public class zzzq {
    ...
    private static long zzo(byte[] bArr) {
        ...
        return zzI((zzI(((((Long.rotateRight(zzb3, 31) + rotateRight3) + (rotateRight4 + Long.rotateRight(rotateRight, 7))) + zzb) * -4288712594273399085L) + (((zzb3 + rotateRight2) + zzb2) * -6505348102511208375L)) * -6505348102511208375L) + zzb2) * -4288712594273399085L;
    }
    ...
    private static long zzp(byte[] bArr) {
        ...
        int i = 0;
        zzb2 = -8261664234251669945L * Long.rotateRight(zzI + zzb, 39);
        length = (length - 1) & -64;
        while (true) {
            ...
            zzb3 = Long.rotateRight(zzI ^ jArr2[0], 33);
            zza(bArr, i, jArr[1] * -8261664234251669945L, jArr2[0] + zzb, jArr);
            zza(bArr, i + 32, zzb3 + jArr2[1], rotateRight, jArr2);
            i += 64;
            int i2 = length - 64;
            if (i2 == 0) {
                return zzc((zzc(jArr[0], jArr2[0]) + (zzI(rotateRight) * -8261664234251669945L)) + zzb, zzc(jArr[1], jArr2[1]) + zzb3);
            }
            zzI = zzb;
            zzb2 = zzb3;
            length = i2;
