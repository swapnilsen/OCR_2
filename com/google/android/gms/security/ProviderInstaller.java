...
public class ProviderInstaller {
    ...
    private static final zze zzbEc;
    ...
    class C14311 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzbEe;
        final /* synthetic */ Context zztf;

        C14311(Context context, ProviderInstallListener providerInstallListener) {
            this.zztf = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C14311(context, providerInstallListener).execute(new Void[0]);
    }
